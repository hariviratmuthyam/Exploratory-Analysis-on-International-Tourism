...
print(inbound_tourists_clean.head())
msg(3)
...
print(inbound_tourists_stack.head())
msg(4)
...
print(growth_inbound_data.head())
msg(9)
...
print(receipts_clean_stack.head())
msg(15)
...
print(*top_export_country_list,sep='  &  ')
msg(19)
...
print(percent_export_stack.head())
msg(20)
...
print(outbound_tourists_clean.head())
msg(28)
...
print(outbound_tourists_stack.head())
msg(29)
...
print(population_outbound("2017"))
msg(36)
...
print(top_expenditure_p_data.head())
msg(42)
...
print(top_expenditure_p_stack.head())
msg(43)
